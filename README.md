...
- `data/maps/` contains bundled scenarios.
- `lib/terrain/` contains terrain and unit sprites.

## UI Snapshot

- The project has a JavaFX desktop UI.
- The board is shown as a clickable grid.
- Bundled scenarios are loaded from `data/maps/`.
...
- The game loads bundled scenarios from `data/maps/` when it starts.
